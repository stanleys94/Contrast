...
{
    public class DateValidator3 : ValidationAttribute
    {
        public DateValidator3() { }
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (value != null)
            {
                ...
                //if(model.tend_date2 != null && dt > model.tend_date2)
                if (DateTime.Compare((DateTime)model.tend_date2, dt) < 0)
                {
